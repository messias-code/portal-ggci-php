...
<body class="bg-[#f8f6fb] text-gray-800 fixed inset-0 p-4 lg:p-6 flex transition-colors duration-500 overflow-hidden">
    ...
    <div class="w-full h-full bg-white/70 backdrop-blur-2xl border border-white/80 rounded-[2rem] shadow-2xl flex overflow-hidden relative z-10">
        ...
        <main class="flex-1 flex flex-col h-full overflow-hidden relative">
            ...
            <!-- CARD 1: FORMATADOR DE LISTAS -->
            <a href="formatador_listas.php" class="group flex flex-row items-center bg-gradient-to-br from-pink-400 to-pink-500 p-5 lg:p-6 border border-white/30 rounded-[2rem] shadow-xl hover:shadow-2xl hover:shadow-pink-500/30 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden w-full max-w-[25rem] min-h-[12rem]">
            ...
            <a href="#" class="group flex flex-row items-center bg-gradient-to-br from-pink-600 to-pink-700 p-5 lg:p-6 border border-white/30 rounded-[2rem] shadow-xl hover:shadow-2xl hover:shadow-pink-700/30 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden w-full max-w-[25rem] min-h-[12rem]">
                ...
                <div class="flex flex-col justify-center text-left flex-1 z-10 w-full">
                    ...
                    <button type="button" class="inline-flex items-center justify-center w-max text-pink-700 bg-white hover:bg-gray-100 hover:scale-[1.03] transition-all font-bold rounded-xl text-[13px] px-4 py-2 shadow-md pointer-events-none">
            ...
            <!-- CARD 3: ANÁLISE IA -->
            <a href="#" class="group flex flex-row items-center bg-gradient-to-br from-purple-500 to-purple-700 p-5 lg:p-6 border border-white/30 rounded-[2rem] shadow-xl hover:shadow-2xl hover:shadow-purple-500/30 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden w-full max-w-[25rem] min-h-[12rem]">
                <div class="absolute -right-10 -top-10 w-48 h-48 bg-white/10 blur-3xl rounded-full group-hover:bg-white/20 transition-all"></div>
                <div class="flex-shrink-0 w-24 h-24 bg-white/10 backdrop-blur-md rounded-[1.2rem] border border-white/30 shadow-[inset_0_0_20px_rgba(255,255,255,0.1)] flex items-center justify-center relative overflow-hidden mr-5 group-hover:bg-white/20 transition-all text-white">
