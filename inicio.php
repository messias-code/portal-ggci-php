...
// Transforma tudo em minúsculo para evitar bugs na hora de mostrar o card
$is_admin = (strtolower($perfil_usuario) === 'administrador');
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>Início - Portal GGCI</title>
    ...
    <div class="w-full h-full bg-white/70 backdrop-blur-2xl border border-white/80 rounded-[2rem] shadow-2xl flex overflow-hidden relative z-10">
        ...
        <aside class="w-[18rem] lg:w-[20rem] flex flex-col border-r border-purple-100/50 bg-white/40">
            ...
            <nav class="flex-1 px-6 py-8 space-y-2 overflow-hidden">
                ...
                <a href="inicio.php" class="flex items-center space-x-3 px-4 py-3 bg-gradient-to-r from-purple-600 to-purple-500 shadow-xl shadow-purple-500/30 text-white rounded-xl font-bold text-base transition-all hover:scale-[1.02]">
                ...
                <a href="gestao_acessos.php" class="group flex flex-row items-center bg-gradient-to-br from-purple-500 to-purple-700 p-5 lg:p-6 border border-white/30 rounded-[2rem] shadow-xl hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden w-full max-w-[25rem] min-h-[12rem]">
                    ...
                    <div class="flex flex-col justify-center text-left flex-1 z-10 w-full">
                        ...
                        <button type="button" class="inline-flex items-center justify-center w-max text-purple-700 bg-white hover:bg-gray-100 hover:scale-[1.03] transition-all font-bold rounded-xl text-[13px] px-4 py-2 shadow-md">
                            Acessar Módulo <svg class="w-4 h-4 ml-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                        </button>
                    </div>
                </a>
                <?php else: ?>
